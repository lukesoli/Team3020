...
<html>
    <head>
        ...
        <meta name="description" content="FRC 3020 SMbld Robotics Team Official Site">
        <link rel="icon" href="./img/3020w.png" type="image/png">
    </head>
    <body>
        <?php
        ...
        <main class="home">
            <div class="front-wrap captionBlock">
                <div class="front-wrap-content">
                    <h1>FRC3020-SMbld Robotics</h1>
                    <p>Robotics Team at <a class="normalLink"
            ...
            <div class="front-wrap currentRobotsBlock">
                <div class="robot-card robotLastest">
                    ...
                    <div class="front-wrap-content robot-content">
                        <h1>2020 Robot</h1>
                        <p><a class="normalLink" href="https://team3020.com/robots">Marvin</a>
                        </p>
                    </div>
                </div>
                <div class="robot-card robotSecondLastest">
                    ...
                    <div class="front-wrap-content robot-content">
                        <h1>2022 Robot</h1>
                        <p><a class="normalLink" href="https://team3020.com/robots">St. Justin</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="front-wrap currentRobotsBlock">
                <div class="robot-card historyBackground">
                    <div class="front-wrap-content paragraph-content">
                        <h1>Story</h1>
                        <p>
                            SMbld Robotics, FIRST team 5805, all began with the inclusion of robotics into Santa Margarita Catholic High School's curriculum during the 2014-2015 school year. During that year, the students in the robotics class became interested in and founded SMbly Required began the journey with Vex competitions prior to the FRC season. Through learning about robotics on the go, and developing a team through the enthusiasm and excitement of the students, FIRST team 3020 was created for the 2015-2016 school year.
                        </p>
                    </div>
                </div>
